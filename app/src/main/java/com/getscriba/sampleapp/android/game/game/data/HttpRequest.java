...
public class HttpRequest {
    ...
    public void abort() {
        try {
            ...
            System.out.println("Scribula 01" + e);
        }
    }
...
//        httpClient.getParams().setParameter(ClientPNames.COOKIE_POLICY, CookiePolicy.RFC_2109);
        ...
        Log.d("Scribula 02", "Setting httpPost headers");

        userAgent = System.getProperty("http.agent");
        Log.d("Scribula 03", "userAgent"+userAgent);
        ...
        try {
            ...
            Log.e("Scribula 04", "HttpUtils : UnsupportedEncodingException : "+e);
        }

        httpPost.setEntity(tmp);

        Log.d("Scribula 05", url + "?" + data);
        ...
        try {
            ...
            Log.e("Scribula 06", "HttpUtils: " + e);
//            isThereNoInternet = true;
        }

        Log.d("Scribula 07", "Returning value:" + ret);
    ...
    public String sendGet(String url) {
        ...
        try {
            ...
            Log.e("Scribula 08", e.getMessage());
        }
        ...
        try {
            ...
            Log.e("Scribula 09", e.getMessage());
        }
